...
public class Main {
  public static void main(String[] args) {
    ...
    /*
     * AI Usage Reflection:
     * I used ChatGPT to double-check my interface implementations and method overrides,
     * especially making sure each subclass correctly called super(id, location) and used
     * setConnected() as required. It helped me verify syntax and formatting quickly,
     * but I still tested the program myself to confirm it ran exactly like the provided
     * driver expected.
     */
  }
}
